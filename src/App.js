  ...
  return (
    <div className="app">
       <div className="sidebar">
        ...
        <FriendsList friends={friends} onSelect={handleSelection} selectFriend={selectFriend} />
...
function FriendsList({friends,onSelect,selectFriend}){
  ...
  return <ul>
    {friends.map(friend=><Friend friend={friend} onSelect={onSelect} selectFriend={selectFriend} key={friend.id}/>)}
  </ul>
}
...
function FormAddFriend({onAddFriend}){
  ...
  return <form className="from-add-friend" onSubmit={handleSubmit}>
...
function FormSplitBill({selectFriend,onSplitBill}){
  ...
  return <form className="form-split-bill" onSubmit={handleSubmit}>
    ...
    <input type="text" value={paidByUser} onChange={(e)=>setPaidByUser(+e.target.value>bill ?paidByFriend:+e.target.value)}/>
